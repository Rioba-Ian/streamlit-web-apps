...
Data obatined from the [palmerpenguins library](https://github.com/allisonhorst/palmerpenguins) in R by Allison Horst.
""")
...
for col in encode:
    ...
    del df[col]
df = df[:1] #selects only first row (user input data)
